...
public class ViewUtility {
    ...
    public static JTable buildTutorContractTable(Contract contractObject, int contractNo) {
        String[][] rec = {
    ...
    public static JTable buildStudentContractTable(Contract contractObject, int contractNo) {
        String[][] rec = {
                {"Contract Number", Integer.toString(contractNo)},
                {"Contract End Date", contractObject.getExpiryDate().toString()},
    ...
    public static JTable buildStudentBidTable(BidInfo bidInfo, int bidNo, Bid bid) {
    ...
    public static JTable buildStudentMessageTable(MessageBidInfo messageBidInfo, Bid bid) {
        String[][] rec = {
    ...
    public static JTable buildTutorMessageTable(MessageBidInfo messageBidInfo, Bid bid) {
